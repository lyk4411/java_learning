...
/**
 * Title: 分割面板 Description: 演示将面板分割成左右两部分 Fiename:SplitPaneDemo.java
 */
public class SplitPaneDemo implements ListSelectionListener {
	...
	/**
	 * 方法说明：构造器，定义了所有要使用的构件 输入参数： 返回类型：
	 */
	...
	/**
	 * 方法说明：获得这个分割的面板 输入参数： 返回类型：JSplitPane 对象
	 */
	...
	/**
	 * 方法说明：列表监听事件处理 输入参数：ListSelectionEvent e 列表选择事件 返回类型：
	 */
	...
	/**
	 * 方法说明：根据路径获取图形对象 输入参数：String path 图片路径 返回类型：ImageIcon 图片对象
	 */
