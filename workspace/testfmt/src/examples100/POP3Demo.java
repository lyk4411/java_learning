...
/**
 * Title: SMTP协议接收邮件 Description: 通过Socket连接POP3服务器，使用SMTP协议接收邮件服务器中的邮件
 * Filename:
 */
class POP3Demo {
	/**
	 * 方法说明：主方法，接收用户输入 输入参数： 返回类型：
	 */
	...
	/**
	 * 方法说明：接收邮件 输入参数：String popServer 服务器地址 输入参数：String popUser 邮箱用户名
	 * 输入参数：String popPassword 邮箱密码 返回类型：
	 */
