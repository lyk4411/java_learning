...
/**
 * Title: 文件操作 Description: 演示文件的删除和获取文件的信息 Filename:
 */
public class fileOperation {
	/**
	 * 方法说明：删除文件 输入参数：String fileName 要删除的文件名 返回类型：boolean 成功为true
	 */
	...
	/**
	 * 方法说明：获取文件信息 输入参数：String Name 文件名 返回类型：String[] 文件信息数组
	 */
	...
	/**
	 * 方法说明：将毫秒数字转换为日期 输入参数：mill 毫秒数 返回类型：String 字符 格式为：yyyy-mm-dd hh:mm
	 */
