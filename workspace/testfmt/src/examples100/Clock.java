...
/**
 * Title: 时钟 Description: 本实例演示使用图形绘制一个图形时钟 Filename: Clock.java
 */
public class Clock extends JFrame implements ActionListener {
	...
	/**
	 * 方法说明：实现ActionListener类必须过载的方法 输入参数： 返回类型：
	 */
	...
	/**
	 * 方法说明：构造器，显示窗体，并添加了一个秒表 输入参数： 返回类型：
	 */
