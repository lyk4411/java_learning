...
public class HuffTree {
	...
	public static void main(String[] args) {
		String oriStr = "中华人民共和国万岁！！！爱我中华！Huffman codes compress data very effectively: savings of 20% to 90% are typical, "
	...
	private static Map<Character, String> buildEncodingInfo(List<Node> leafNodes) {//leafNodes  含有内容和频率信息
