...
/**
 * Title: 操作EXCEL文件 Description: 本实例演示使用jxl包实现对excel文件的操作 Filename: myExcel.java
 */
public class myExcel {
	...
	/**
	 * 方法说明：读取excel文件一行数据 输入参数：int row指定的行数 返回类型：String〔〕结果数组
	 */
