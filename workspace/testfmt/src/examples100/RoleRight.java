...
/**
 * Title: 哈希表操作 Description: 这是一个权限认证的例子，使用了哈希表作为数据的存储 Filename: RoleRight.java
 */
public class RoleRight {
	 ...
	 * 方法说明：添加角色和代码信息 <br>
	 * 输入参数：String accRole 角色名称 <br>
	 * 输入参数：String rightCode 角色权限代码 <br>
	 * 返回类型：void （无）
	 */
