...
/**
 * Creates an image, adds some text, and writes it out to a file. In fact, it
 * creates a bunch of files, for use as icons in the Java Cookbook.
 * 
 * @author Ian Darwin
 */
public class CreateAndSaveImage {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int v : VERSIONS) {
			...
			Rectangle2D lineMetrics = f.getStringBounds(bigNumberLabel,
			...
			ImageIO.write(image, "jpg",
					new File(String.format("u.jpg", dir, v)));
		}
