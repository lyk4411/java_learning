...
/**
 * Demo of making TrueType font usable in Java. This facility allows you to have
 * "application-specific" fonts in Java; your application can have its own
 * distinctive font that the user does NOT have to install into the JRE before
 * you can use it. (of course they can install it if they have privileges and
 * want to).
 * <p>
 * Must remain Swing-based despite problems on older systems, since only Swing
 * components can use TTF fonts in this implementation.
 * <p>
 * Did NOT work for me in Applet nor JApplet due to security problems (requires
 * to create a temp file). Could be made to work by providing a policy file.
 * 
 * @author Ian Darwin
 * @since 1.3
 */
...
public class TTFontDemo extends JLabel {
	...
	public TTFontDemo(String fontFileName, String text) throws IOException,
			FontFormatException {
