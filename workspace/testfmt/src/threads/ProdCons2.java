...
public class ProdCons2 {
	/**
	 * Throughout the code, this is the object we synchronize on so this is also
	 * the object we wait() and notifyAll() on.
	 */
		...
		public void run() {
			while (true) {
				...
				synchronized (list) {
					...
					System.out.println("Produced 1; List size now "
							+ list.size());
					if (done)
						break;
