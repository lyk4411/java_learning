...
public class MyData implements Serializable {
	...
	/**
	 * Save the clear text p/w in the object, it won't get serialized So we must
	 * save the encryption! Encryption not shown here.
	 */
	...
	public String toString() {
		return "MyData[" + userName + ",------] + " + serialVersionUID;
	}
