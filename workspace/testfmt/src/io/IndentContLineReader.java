...
/**
 * Subclass of ContLineReader for lines continued by indentation of following
 * line (like RFC822 mail, Usenet News, etc.). Normally you would read header &
 * body of the message(s) with code like:
 * 
 * <pre>
...
public class IndentContLineReader extends ContLineReader {
	...
	/**
	 * Read one (possibly continued) line, stripping out the '\'s that mark the
	 * end of all but the last.
	 */
	...
	protected static String sampleTxt = 
			...
			+ "     llll \n"
			+ "    l \n";
	private static IndentContLineReader is;
	
	public static void main(String argv[]) throws IOException {
		is = new IndentContLineReader( new StringReader(sampleTxt));
		String aLine;
