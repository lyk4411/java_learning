...
/**
 * Demonstrate use of Serialization. Typical Subclass main will be: public
 * static void main(String[] s) throws Exception { new SerialDemoXXX().save();
 * // in parent class; calls write new SerialDemoXXX().dump(); }
 */
