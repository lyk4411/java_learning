 ...
 * 
 * @author Ian F. Darwin, [email]ian@darwinsys.com[/email] based on the standard
 *         UNIX getopt(3) program.
...
class GetOpt {
	...
	/**
	 * Public constant for "no more options" XXX should switch to
	 * hasNext()/next() pattern.
	 */
