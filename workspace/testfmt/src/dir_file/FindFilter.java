...
// BEGIN main
/**
 * Class to encapsulate the filtration for Find. For now just setTTTFilter()
 * methods. Really needs to be a real data structure to allow complex things
 * like -n "*.html" -a \( -size < 0 -o mtime < 5 \).
 */
