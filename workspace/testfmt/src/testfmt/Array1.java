...
/**
 * Review examples of arrays: shows array allocation, processing, storing
 * objects in Arrays,, two-dimensional arrays, and lengths.
 * 
 * @author Ian Darwin
 */
// BEGIN main
public class Array1 {
	...
	public static void main(String[] argv) {
		...
		for (int i = 0; i < MAX; i++) {
			...
			// System.out.println(days[i].getFirstDayOfWeek());
		}
