...
public class EnTab {
	...
	/**
	 * Main program: just create an EnTab object, and pass the standard input or
	 * the named file(s) through it.
	 */
	public static void main(String[] argv) throws IOException {
		...
		if (argv.length == 0) // do standard input
			...
			for (String fileName : argv) { // do each file
				et.entab(new BufferedReader(new FileReader(fileName)),
						System.out);
			}
	}
	 ...
	 * 
	 * @param is
	 *            A BufferedReader opened to the file to be read.
	 * @param out
