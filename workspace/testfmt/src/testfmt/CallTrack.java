...
/**
 * Code Fragmment showing how to insert in two lists (an ArrayList and an AWT
 * List) in sorted order, using a simple linear search of the ArrayList to find
 * the object (or end of list) before which to insert the new user.
 */
// BEGIN main
