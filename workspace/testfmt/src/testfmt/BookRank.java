 ...
 *         originally translated fairly literally from Perl into Java, and
 *         rewritten several times since.
 * @author Patrick Killelea
 *         <p@patrick.net>
 *         : original Perl version, from the 2nd edition of his book
...
public class BookRank {
	...
	public static void main(String[] args) throws Exception {
		...
		p.load(new FileInputStream(args.length == 0 ? "bookrank.properties"
				: args[1]));
