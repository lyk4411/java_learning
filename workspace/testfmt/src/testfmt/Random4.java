...
/**
 * Print "n" calls to nextDouble() and nextGaussian() in raw form using
 * java.util.Random.next*(); results can be plotted (for example, using the "R"
 * script randomnesshistograms.r).
 */
