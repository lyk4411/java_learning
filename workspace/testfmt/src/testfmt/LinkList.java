...
/**
 * Linked list class, written in Java. This is <b>not</b> intended to be a
 * usable List, and it is certainly not going to be optimal in terms of
 * performance; it is just here to remind you how much work the existing List
