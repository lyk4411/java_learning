...
/**
 * GUI for TestOpenMailRelay, lets you run it multiple times in one JVM to avoid
 * startup delay.
 * 
...
public class TestOpenMailRelayGUI extends JFrame {
	...
	/**
	 * This inner class is the action handler both for pressing the "Try" button
	 * and also for pressing <ENTER> in the text field. It gets the IP
	 * name/address from the text field and passes it to process() in the main
	 * class. Run in the GUI Dispatch thread to avoid messing the GUI. --
	 * tmurtagh.
	 */
	...
	/**
	 * Construct a GUI and some I/O plumbing to get the output of
	 * "TestOpenMailRelay" into the "results" textfield.
	 */
