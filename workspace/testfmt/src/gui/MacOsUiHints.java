...
// BEGIN main
/**
 * Interactive test for "macosui" package. Class cannot extend JFrame; must set
 * properties before first call to any Swing constructor.
 */
public class MacOsUiHints {
	public static void main(String[] args) throws Exception {
		// OS X Tester:
		// check that the File Edit View menu appears atop the desktop not the
		// window
