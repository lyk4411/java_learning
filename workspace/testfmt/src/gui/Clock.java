...
public class Clock extends Applet implements Runnable {
	 ...
	 * second, it updates the text of the Label to display the current time. AWT
	 * and Swing components are not, in general, thread-safe, and should
	 * typically only be updated from the event-handling thread. We can get away
	 * with using a separate thread here because there is no event handling in
	 * this applet, and this component will never be modified by any other
	 * thread.
	 **/
	public void run() {
