...
/**
 * EchoClientOneLine - create client socket, send one line, read it back. See
 * also EchoClient.java, slightly fancier.
 */
// BEGIN main
public class EchoClientOneLine {
	...
	public static void main(String[] argv) {
		if (argv.length == 0)
			new EchoClientOneLine().converse("www.hao123.com");
		else
