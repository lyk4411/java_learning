...
public class InetAddrDemo {
	public static void main(String[] args) throws IOException {
		...
		String ipNumber = "10.50.119.22"; // currently a well-known Google DNS server
		...
		String someServerName = "www.hao123.com";
		...
		System.out.printf("The InetAddress for %s is %s%n", someServerName,
				remote);
	}
}
// END main